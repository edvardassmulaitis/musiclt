...
export const SONG_COLLECTIONS: SongCollection[] = [
  {
    slug: 'visu-laiku-geriausios-lietuviskos', title: 'Visų laikų geriausios lietuviškos dainos', emoji: '🇱🇹', group: 'tema',
    metaTitle: `Visų laikų geriausios lietuviškos dainos | ${SITE}`,
    description: 'Visų laikų geriausios lietuviškos dainos — nemirštantys hitai, kuriuos žino kiekvienas. Geriausių lietuviškų dainų rinkinys per kartas.',
    intro: 'Yra dainų, kurias moka kiekvienas lietuvis. Šiame rinkinyje — visų laikų geriausios lietuviškos dainos: estrados, roko ir poso klasika, skambanti vestuvėse, gimtadieniuose ir prie laužo. Auksinis lietuviškos muzikos fondas, perduodamas iš kartos į kartą.',
  },
  {
    slug: 'liaudies-dainos', title: 'Lietuvių liaudies dainos', emoji: '🪕', group: 'tema',
    metaTitle: `Lietuvių liaudies dainos — populiariausios liaudies dainos | ${SITE}`,
    description: 'Populiariausios lietuvių liaudies dainos su žodžiais: dainos apie Lietuvą, gamtą ir meilę, sutartinės. Liaudies dainų rinkinys visai šeimai.',
    intro: 'Lietuvių liaudies daina — tautos atmintis ir širdis. Surinkome populiariausias liaudies dainas su žodžiais: apie Lietuvą, gamtą, darbą ir meilę. Dainos, skambančios per šventes, susibūrimus ir dainų šventes — iš kartos į kartą.',
  },
  {
    slug: 'meiles-dainos', title: 'Dainos apie meilę', emoji: '❤️', group: 'tema',
    metaTitle: `Dainos apie meilę — gražiausios meilės dainos su žodžiais | ${SITE}`,
  ...
  {
    slug: 'patriotines-dainos', title: 'Patriotinės dainos', emoji: '🇱🇹', group: 'tema',
    metaTitle: `Patriotinės dainos — dainos apie Lietuvą ir laisvę | ${SITE}`,
    description: 'Patriotinės lietuviškos dainos: kūriniai apie Tėvynę, laisvę ir Lietuvą. Patriotinių dainų su žodžiais rinkinys valstybinėms šventėms.',
    intro: 'Patriotinė daina suvienija. Šiame rinkinyje — dainos apie Lietuvą, laisvę ir Tėvynę: nuo Dainuojančios revoliucijos himnų iki šiuolaikinių kūrinių. Dainos Vasario 16-ajai, Kovo 11-ajai ir kiekvienam, kuriam brangi Lietuva.',
  },
  {
    slug: 'lopsines', title: 'Lopšinės', emoji: '🌙', group: 'tema',
    metaTitle: `Lopšinės — ramios dainos vaikams užmigti, su žodžiais | ${SITE}`,
  ...
  {
    slug: 'dainos-vaikams', title: 'Dainos vaikams', emoji: '🧸', group: 'tema',
    metaTitle: `Dainos vaikams — linksmos vaikiškos dainos su žodžiais | ${SITE}`,
    description: 'Geriausios dainos vaikams: linksmos lietuviškos vaikiškos dainos su žodžiais žaidimui, šokiui ir mokymuisi.',
    intro: 'Vaikiška daina moko, linksmina ir augina. Surinkome geriausias dainas vaikams — linksmas lietuviškas vaikiškas dainas su žodžiais žaidimui, šokiui, karaoke ir mokymuisi. Mėgstamiausi kūriniai mažiesiems vienoje vietoje.',
  },
  {
    slug: '90-uju-hitai', title: '90-ųjų dainos', emoji: '📼', group: 'tema',
    metaTitle: `90-ųjų dainos — dešimtmečio hitai (lietuviškos ir užsienio) | ${SITE}`,
    description: '90-ųjų dainos: dešimtmečio populiariausi hitai, lietuviškos ir užsienio. Nostalgiškas 90-ųjų muzikos rinkinys.',
    intro: 'Dešimtmetis, kurio garsą atpažįsta visi. Surinkome 90-ųjų dainas — populiariausius dešimtmečio hitus, lietuviškus ir užsienio. Nostalgiškas rinkinys tiems, kas užaugo su šia muzika, ir tiems, kas atranda ją iš naujo.',
  },
  {
    slug: '2000-uju-hitai', title: '2000-ųjų dainos', emoji: '💿', group: 'tema',
    metaTitle: `2000-ųjų dainos — dešimtmečio hitai (lietuviškos ir užsienio) | ${SITE}`,
    description: '2000-ųjų dainos: dešimtmečio populiariausi hitai, lietuviškos ir užsienio. Nostalgiškas 2000-ųjų muzikos rinkinys.',
    intro: 'Dainos, skambėjusios per kiekvieną vakarėlį ir radiją. Surinkome 2000-ųjų dainas — populiariausius dešimtmečio hitus, lietuviškus ir užsienio. Nostalgija visiems, kurie prisimena šį dešimtmetį.',
  },
  {
    slug: 'vestuviu-dainos', title: 'Vestuvių dainos', emoji: '💍', group: 'tema',
    metaTitle: `Vestuvių dainos — geriausios lietuviškos dainos vestuvėms | ${SITE}`,
  ...
  {
    slug: 'vasaros-dainos', title: 'Vasaros dainos', emoji: '☀️', group: 'tema',
    metaTitle: `Vasaros dainos — karščiausi vasaros hitai | ${SITE}`,
    description: 'Vasaros dainos: karščiausi sezono hitai paplūdimiui, kelionei ir vakarėliui. Lietuvių ir pasaulio atlikėjų vasaros muzika.',
    intro: 'Kiekviena vasara turi savo garso takelį. Surinkome karščiausias vasaros dainas — energingiausius sezono hitus paplūdimiui, automobiliui ir vakarėliui. Lietuvių ir pasaulio atlikėjų kūriniai, skambantys visur vasarą.',
  },
  {
  ...
  {
    slug: 'chill', title: 'Ramios dainos', emoji: '🧊', group: 'nuotaika',
    metaTitle: `Ramios dainos — rami muzika atsipalaidavimui ir fonui | ${SITE}`,
    description: 'Ramios dainos atsipalaidavimui: rami muzika darbui, mokslams ar poilsiui. Raminančių kūrinių rinkinys fonui.',
    intro: 'Kartais reikia tiesiog sulėtinti tempą. Šiame rinkinyje — ramios dainos, tinkančios fonui dirbant, mokantis ar tiesiog ilsintis. Švelnios melodijos ir raminantys bitai be skubėjimo.',
  },
  {
    slug: 'workout', title: 'Dainos sportui', emoji: '💪', group: 'nuotaika',
    metaTitle: `Dainos sportui — energinga muzika treniruotei ir bėgimui | ${SITE}`,
    description: 'Dainos sportui: energinga muzika treniruotei, bėgimui ir sporto salei. Greito ritmo kūrinių rinkinys motyvacijai.',
    intro: 'Tinkamas ritmas gali padvigubinti treniruotės jėgą. Surinkome energingiausias dainas sportui — bėgimui, sporto salei ir kardio treniruotėms, greito tempo kūrinius, kurie nukels motyvaciją į kitą lygį. Pumpuok garsą ir spausk toliau.',
  },
  {
    slug: 'vakareliu-muzika', title: 'Vakarėlių dainos', emoji: '🎉', group: 'nuotaika',
    metaTitle: `Vakarėlių dainos — geriausios party dainos šokiui | ${SITE}`,
    description: 'Vakarėlių dainos: karščiausios party dainos, kurios pakels visus šokti. Lietuviškų ir užsienio hitų rinkinys vakarėliui.',
  ...
  {
    slug: 'linksmos-dainos', title: 'Linksmos dainos', emoji: '😄', group: 'nuotaika',
    metaTitle: `Linksmos dainos — geros nuotaikos dainos | ${SITE}`,
    description: 'Linksmos dainos gerai nuotaikai: energingos lietuviškos ir užsienio dainos, kurios pradžiugins ir pakels.',
    intro: 'Yra dainų, kurios tiesiog priverčia šypsotis. Surinkome linksmas dainas gerai nuotaikai — energingus lietuviškus ir užsienio kūrinius, kurie pradžiugins rytą, kelionę ar bet kurią akimirką, kai norisi šiek tiek daugiau saulės.',
  },
  {
