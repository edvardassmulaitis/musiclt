    ...
    <div className="mt-1 space-y-1">
      ...
      {olderCount > 0 && (
        <button
          ...
          className="ml-1 inline-flex items-center gap-1 text-[14px] font-bold text-[var(--text-faint)] transition-colors hover:text-[var(--accent-orange)]"
        >
      ...
      {showCount && (
        onOpenModal ? (
          <button
            ...
            className={[
              "flex items-center border-l px-2 py-1 font-['Outfit',sans-serif] text-[12px] font-extrabold tabular-nums tracking-wide transition-colors",
          ...
          <span
            className={[
              "flex items-center border-l px-2 py-1 font-['Outfit',sans-serif] text-[12px] font-extrabold tabular-nums tracking-wide",
...
export default function EntityCommentsBlock({
  ...
  const SortChip = ({ k, label }: { k: 'newest' | 'oldest' | 'popular'; label: string }) => (
    <button
      ...
      onClick={() => setSort(k)}
      className={[
        "rounded-full px-2.5 py-1 font-['Outfit',sans-serif] text-[12px] font-extrabold transition-colors",
        sort === k
  ...
  const Composer = (
    <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-3">
      ...
      {error && (
        <div className="mt-2 text-[14px] font-bold text-[#ef4444]">{error}</div>
      )}
      {!session?.user?.id && (
        <div className="mt-2 text-[14px] text-[var(--text-faint)]">
  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      {toast && (
        ...
        >
          <div
            className="flex items-center gap-2 rounded-full px-4 py-2 text-[14px] font-bold shadow-2xl"
            style={{
      ...
      {modern === null || legacy === null ? (
        ...
        <div className="rounded-xl border border-dashed border-[var(--border-default)] px-4 py-6 text-center">
          <div className="text-[14px] font-bold text-[var(--text-muted)]">Komentarų dar nėra</div>
          <div className="mt-1 text-[14px] text-[var(--text-faint)]">
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
                      ...
                      {rel && (
                        <span
                          className="text-[14px] font-semibold text-[var(--text-muted)]"
                    ...
                    {quoteAuthor && quoteText && (
                      <div className="mt-1.5 rounded border-l-[3px] border-[var(--accent-orange)] bg-[var(--bg-elevated)] px-2.5 py-1.5">
                        ...
                        <div className="mt-0.5 line-clamp-3 text-[14px] italic text-[var(--text-muted)]">
                          {quoteText}
                        </div>
                      </div>
                    )}
                      ...
                      {isDeleted && isModern && (() => {
                        ...
                        return (
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-full border border-[var(--accent-orange)]/40 bg-[var(--accent-orange)]/10 px-2 py-0.5 font-['Outfit',sans-serif] text-[12px] font-extrabold text-[var(--accent-orange)] transition-colors hover:bg-[var(--accent-orange)]/20"
                          >
                      ...
                      {(() => {
                        ...
                        return (
                          <button
                            ...
                            className="ml-auto inline-flex items-center gap-1 rounded-full border border-[rgba(239,68,68,0.3)] bg-[rgba(239,68,68,0.08)] px-2 py-0.5 font-['Outfit',sans-serif] text-[12px] font-extrabold text-[#ef4444] transition-colors hover:border-[#ef4444] hover:bg-[rgba(239,68,68,0.16)]"
                          >
        ...
        >
          ...
          >
            ...
            <div className="px-4 py-3">
              ...
              {replyAttached.length > 0 && (
                <div className="mt-2 flex flex-wrap gap-1.5">
                  {replyAttached.map((a, i) => (
                    <div
                      key={`${a.type}-${a.id}-${i}`}
                      className="inline-flex items-center gap-1 rounded-full border border-[var(--border-subtle)] bg-[var(--bg-elevated)] px-2 py-1 text-[14px]"
                    >
              ...
              {replyError && (
                <div className="mt-2 rounded-md border border-red-500/30 bg-red-500/10 px-2 py-1 text-[14px] text-red-400">
                  {replyError}
                </div>
              )}
              ...
              <div className="mt-3 flex items-center justify-between gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-full border border-[var(--border-default)] bg-[var(--bg-elevated)] px-3 py-1.5 text-[14px] font-bold text-[var(--text-secondary)] hover:bg-[var(--bg-hover)]"
                >
                  ♪ Pridėti dainos
                </button>
