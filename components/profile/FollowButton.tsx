...
export function FollowButton({
  ...
  // Dydis kaip „Dalintis" (ShareButton): px-3 py-1 text-[13px], 12px ikona.
  ...
  const base = compactCircle
    ...
    : 'inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[13px] font-bold transition hover:opacity-90 active:scale-[0.97] disabled:opacity-60'
