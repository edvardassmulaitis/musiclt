...
export async function PUT(req: NextRequest) {
  ...
  const allowed = ['full_name', 'username', 'bio', 'website', 'avatar_url', 'cover_image_url', 'social_twitter', 'social_spotify', 'social_youtube', 'social_tiktok', 'is_public', 'hide_from_homepage', 'legacy_signature', 'legacy_city', 'legacy_occupation', 'legacy_birth_date', 'legacy_favorite_books', 'legacy_favorite_films', 'legacy_profile_photos', 'default_profile_tab']
