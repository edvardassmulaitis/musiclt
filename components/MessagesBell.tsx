    ...
    <>
      ...
      <div style={{ padding: '10px 16px', borderTop: '1px solid var(--border-subtle)', textAlign: 'center' }}>
        <Link
          ...
          style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-muted)', textDecoration: 'none' }}
        >
    ...
    >
      {m.author_avatar ? (
        ...
        <div
          style={{
            ...
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            color: `hsl(${hue},48%,55%)`, fontSize: 14, fontWeight: 800,
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', gap: 6, alignItems: 'baseline', marginBottom: 2 }}>
          <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--accent-link)' }}>{m.author_name}</span>
          <span style={{ fontSize: 12, color: 'var(--text-faint)' }}>{shortAgo(m.created_at)}</span>
        </div>
        <p
          style={{
