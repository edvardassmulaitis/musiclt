...
export function MasterSearch({ open, onClose }: MasterSearchProps) {
  ...
  useEffect(() => {
    ...
    // 2026-05-28: debounce 140ms → 220ms. User'iai pranešė, kad paieška
    // inicijuojasi „labai greitai" — kol dar baigia rašyti, ankstesni
    // fetch'ai jau pradeda paleisti. 220ms reiškia: kol user'is daro >2
    // pause'es per sekundę, request'as nesiunčiamas. Tipinė typing'o
    // pause yra ~80-150ms tarp keystroke'ų, ~250-400ms tarp žodžių, todėl
    // 220ms patikimai sulaiko fetch'ą iki frazes pauzės.
