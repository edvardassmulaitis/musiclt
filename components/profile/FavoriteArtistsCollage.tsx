      ...
      {shown.map((a, i) => {
        ...
        return (
          ...
          >
            ...
            {score > 0 && isHero && (
              <div className="absolute top-2 right-2 px-2 py-0.5 rounded-full backdrop-blur-md text-[10px] font-extrabold uppercase tracking-wider flex items-center gap-1"
