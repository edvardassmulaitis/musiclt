...
function MusicMeterEqualizer({ meter }: { meter: MeterEntry[] }) {
  ...
  return (
    <div>
      ...
      <p className="text-[12px] text-[#5e7290] text-center mt-2" style={{ fontFamily: "'Outfit', sans-serif" }}>
...
function MoodSongCard({ track }: { track: MoodTrack }) {
  ...
  return (
    <div className="flex flex-col items-center text-center py-4">
      ...
      <div className="text-[12px] uppercase tracking-[0.2em] text-orange-400 font-bold mb-1" style={{ fontFamily: "'Outfit', sans-serif" }}>
