...
function PlayerCard({
  ...
  return (
    ...
    >
      ...
      >
        {displayVid ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-2.5 px-6 text-center">
            ...
            <div className="font-['Outfit',sans-serif] text-[16px] font-extrabold uppercase tracking-[0.15em] text-white/60">
              Video dar nėra
            </div>
          </div>
        )}
      ...
      >
        {list.length === 0 ? (
          <div className="flex min-h-[160px] flex-col items-center justify-center gap-1 px-6 py-8 text-center">
            <div className="font-['Outfit',sans-serif] text-[16px] font-extrabold uppercase tracking-wider text-[var(--text-muted)]">Nieko</div>
      ...
      {!hasAnyVideo && (
        <div className="border-t border-[var(--border-default)] bg-[var(--bg-elevated)] px-4 py-2 text-center font-['Outfit',sans-serif] text-[12px] font-bold uppercase tracking-[0.12em] text-[var(--text-muted)]">
...
function TabButton({ active, disabled, onClick, children }: {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={[
        'relative border-0 bg-transparent px-4 py-3 font-["Outfit",sans-serif] text-[16px] font-extrabold uppercase tracking-[0.14em] transition-colors',
              ...
              >
                ...
                {(genres[0] || (flag && artist.country)) && (
                  <button
                    ...
                    className="inline-flex shrink-0 items-center gap-2 rounded-full border border-[rgba(249,115,22,0.35)] bg-[rgba(249,115,22,0.12)] py-1.5 pl-2.5 pr-2.5 font-['Outfit',sans-serif] text-[16px] font-extrabold tracking-tight text-[var(--accent-orange)] transition-colors hover:border-[var(--accent-orange)] hover:bg-[rgba(249,115,22,0.22)] lg:bg-[rgba(249,115,22,0.18)] lg:backdrop-blur-md lg:hover:bg-[rgba(249,115,22,0.28)]"
                  >
                    {flag && artist.country && (
        ...
        {upcomingEvents.length > 0 && (() => {
          ...
          return (
            ...
            <div className="hidden flex-col gap-2 lg:flex lg:self-stretch">
              <div className="font-['Outfit',sans-serif] text-[12px] font-extrabold uppercase tracking-[0.18em] text-white/85">
              ...
              {hasOverflow && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 rounded-xl border border-dashed border-[rgba(249,115,22,0.4)] bg-[rgba(249,115,22,0.06)] px-3 py-2 text-[16px] font-extrabold text-[var(--accent-orange)] transition-all hover:border-[rgba(249,115,22,0.7)] hover:bg-[rgba(249,115,22,0.10)]"
                >
        ...
        <div className="flex items-center justify-between gap-3 border-b border-[var(--border-subtle)] px-5 py-4">
          <div className="min-w-0 flex-1">
            ...
            {myRank && currentArtistName && (
              <div className="mt-0.5 font-['Outfit',sans-serif] text-[14px] font-bold text-[var(--accent-orange)]">
              ...
              {items.map((a, i) => {
                ...
                return (
                  <li key={a.id}>
                    ...
                    >
                      <span className="w-7 shrink-0 text-right font-['Outfit',sans-serif] text-[16px] font-extrabold tabular-nums text-[var(--text-faint)] group-hover:text-[var(--accent-orange)]">
                        {i + 1}
                      </span>
                      <span className="relative h-12 w-12 shrink-0 overflow-hidden rounded-full bg-[var(--card-bg)]">
                        {a.cover_image_url ? (
                          ...
                          <span className="flex h-full w-full items-center justify-center text-[14px] font-bold uppercase text-[var(--text-faint)]">
                            {a.name.charAt(0)}
                          </span>
                        )}
                      </span>
...
function ShareButton({ url, title, fullWidth = false }: { url: string; title: string; fullWidth?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <span className="font-['Outfit',sans-serif] text-[16px] font-extrabold tracking-tight">
    ...
    >
      ...
      {countClickable ? (
        <button
          ...
          className={[
            'flex items-center border-l px-3.5 py-2 font-["Outfit",sans-serif] text-[16px] font-extrabold tabular-nums tracking-wide transition-colors',
            heartFilled
        ...
        <span className={[
          'flex items-center border-l px-3.5 py-2 font-["Outfit",sans-serif] text-[16px] font-extrabold tabular-nums tracking-wide',
        ...
        <div className="flex w-full flex-nowrap items-center gap-1.5">
          ...
          {overflowCount > 0 && (
            <button
              ...
              title="Visi linkai"
              className="flex h-9 shrink-0 items-center gap-1 rounded-full border border-dashed border-[var(--border-default)] bg-transparent px-2.5 font-['Outfit',sans-serif] text-[16px] font-extrabold text-[var(--text-secondary)] transition-colors hover:border-[var(--accent-orange)] hover:bg-[rgba(249,115,22,0.08)] hover:text-[var(--accent-orange)]"
            >
        ...
        >
          ...
          {showAllTrigger && (
            ...
            >
              ...
              <span className="font-['Outfit',sans-serif] text-[14px] font-bold leading-tight">Visi nariai</span>
            </button>
          )}
        </div>
      </div>
...
function MemberSeparator() {
  return (
    <div className="flex shrink-0 flex-col items-center justify-center self-stretch px-1" aria-hidden>
      <span className="font-['Outfit',sans-serif] text-[12px] font-bold uppercase tracking-[0.15em] text-[var(--text-faint)] whitespace-nowrap">
        Buvę
      </span>
...
function PhotoCredit({ photo }: { photo: Photo }) {
  ...
  return (
    <div className="mt-3 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-[14px] text-white/60">
...
function Lightbox({
  ...
  return createPortal(
    ...
    >
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 font-['Outfit',sans-serif] text-[14px] font-bold text-white/40">
  ...
  const photoCard = (p: Photo, i: number) => {
    ...
    return (
      ...
      >
        ...
        />
        {year && (
          <span className="absolute bottom-1.5 right-1.5 rounded-md bg-black/70 px-1.5 py-0.5 font-['Outfit',sans-serif] text-[12px] font-bold text-white backdrop-blur-sm">
            {year}
          </span>
        )}
      </button>
  ...
  const moreTile = showMore ? (
    ...
    >
      ...
      <span className="absolute inset-0 flex flex-col items-center justify-center gap-1 bg-black/55 text-white transition-colors group-hover:bg-black/45">
        ...
        <span className="font-['Outfit',sans-serif] text-[14px] font-bold uppercase tracking-[0.12em]">daugiau</span>
      </span>
    </button>
  ) : null
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-center gap-1.5 px-4 py-4 sm:px-5">
        ...
        {venue && (
          <div className="line-clamp-2 text-[14px] leading-snug text-[var(--text-secondary)]">
...
function EventBigCard({ e, onOpen }: { e: any; onOpen?: (e: any) => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <div className="font-['Outfit',sans-serif] text-[16px] font-extrabold uppercase tracking-[0.1em] text-[var(--accent-orange)]">
          {longDate}
        </div>
...
function MobileFilterRow({
  ...
  const Chip = ({ item, active }: { item: FilterItem; active: boolean }) => (
    <button
      ...
      className={[
        'inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 font-["Outfit",sans-serif] text-[14px] font-bold transition-all',
        active
    ...
    <div className="mb-6 overflow-hidden rounded-2xl border border-[var(--border-default)] bg-gradient-to-r from-[rgba(249,115,22,0.08)] via-[var(--bg-surface)] to-[var(--bg-surface)] p-3 sm:mb-8 sm:p-5">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 font-['Outfit',sans-serif] text-[14px] font-bold text-[var(--text-muted)] sm:text-[14px]">
            {album.year || '—'}
          </div>
          {topTracks.length > 0 && (
            <div className="mt-3 flex flex-wrap items-center gap-x-2 gap-y-1 font-['Outfit',sans-serif] text-[14px] font-medium text-[var(--text-secondary)] sm:text-[14px]">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {firstTrack && (
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-[var(--accent-orange)] px-3.5 py-1.5 font-['Outfit',sans-serif] text-[16px] font-extrabold text-white shadow-[0_4px_14px_rgba(249,115,22,0.35)] transition-transform hover:scale-105"
              >
            ...
            <button
              type="button"
              onClick={onOpen}
              className="inline-flex items-center gap-1.5 rounded-full border border-[var(--border-default)] bg-[var(--card-bg)] px-3.5 py-1.5 font-['Outfit',sans-serif] text-[14px] font-bold text-[var(--text-secondary)] transition-colors hover:border-[var(--accent-orange)] hover:text-[var(--accent-orange)]"
            >
              Albumas
            </button>
          </div>
    ...
    <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-3 sm:p-4">
      <div className="mb-3 flex items-baseline justify-between gap-3">
        <div className="flex min-w-0 items-baseline gap-2">
          <h3 className="truncate font-['Outfit',sans-serif] text-[16px] font-extrabold text-[var(--text-primary)] sm:text-[16px]">
            {title}
          </h3>
          {subtitle && (
            <span className="truncate font-['Outfit',sans-serif] text-[14px] font-medium text-[var(--text-secondary)]">
              — {subtitle}
            </span>
          )}
          {rangeLabel && (
      ...
      {description && (
        <p className="mb-3 max-w-prose font-['Outfit',sans-serif] text-[14px] font-medium leading-snug text-[var(--text-secondary)]">
          {description}
        </p>
      )}
      {children}
...
function TrackRow({ t, popularity, artistSlug, onOpen }: { t: Track; popularity?: number; artistSlug?: string; onOpen?: (t: Track) => void }) {
  ...
  const inner = (
    <>
      ...
      <div className="min-w-0 flex-1">
        <div className="truncate font-['Outfit',sans-serif] text-[14px] font-bold text-[var(--text-primary)] sm:text-[14px]">
          {t.title}
        </div>
    ...
    <>
      ...
      {pc > 0 && (
        <div className="border-t border-[var(--border-subtle)] pt-2">
          <span className="font-['Outfit',sans-serif] text-[16px] font-extrabold text-[var(--accent-orange)] group-hover:underline">
...
function DiscussionFollowHeart({ discussionId }: { discussionId?: number }) {
  ...
  return (
    ...
    >
      ...
      {shown > 0 && (
        <span className="font-['Outfit',sans-serif] text-[16px] font-extrabold tabular-nums">{shown.toLocaleString('lt-LT')}</span>
      )}
    </button>
  )
}
...
function DiscussionThreadModal({
  ...
  const SortChip = ({ k, label }: { k: 'oldest' | 'newest' | 'popular'; label: string }) => (
    <button
      ...
      onClick={() => setSort(k)}
      className={[
        'rounded-full px-3 py-1 font-["Outfit",sans-serif] text-[16px] font-extrabold transition-colors',
        sort === k
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-5 py-5 sm:px-6">
          ...
          <div className="mb-4 border-b border-[var(--border-subtle)] pb-4">
            ...
            {pc > 0 && (
              <div className="mt-2 font-['Outfit',sans-serif] text-[14px] font-bold text-[var(--text-muted)]">
          ...
          {thread.id ? (
            ...
            <div className="rounded-xl border border-dashed border-[var(--border-subtle)] bg-[var(--bg-elevated)] px-4 py-8 text-center text-[14px] text-[var(--text-faint)]">
  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-xl border bg-[var(--bg-surface)]" style={{ borderColor: 'rgba(249,115,22,0.35)' }}>
      <div className="flex items-center gap-2 px-3.5 pb-1.5 pt-3">
        ...
        <span className="font-['Outfit',sans-serif] text-[12px] font-extrabold uppercase tracking-[0.1em] text-[var(--accent-orange)]">
          Muzikos atradimas
        </span>
      ...
      {discoveries.length > 6 && !showAll && (
        <div className="mt-3 flex justify-center">
          <button
            ...
            className="rounded-full border border-[var(--border-default)] bg-[var(--bg-surface)] px-4 py-2 font-['Outfit',sans-serif] text-[14px] font-bold text-[var(--text-secondary)] transition-colors hover:border-[var(--accent-orange)] hover:text-[var(--text-primary)]"
          >
        ...
        <div className="fixed bottom-4 left-1/2 z-[2000] -translate-x-1/2 sm:bottom-6">
          <div className="flex max-w-[560px] items-start gap-3 rounded-2xl border border-[rgba(239,68,68,0.35)] bg-[var(--bg-surface)] p-4 shadow-[0_18px_44px_-10px_rgba(0,0,0,0.5)]">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[14px] leading-[1.5] text-[var(--text-secondary)]">
                {likeErrorMsg}
              </div>
            </div>
            <button
        ...
        <div className="fixed bottom-4 left-1/2 z-[2000] -translate-x-1/2 sm:bottom-6">
          <div className="flex max-w-[520px] items-start gap-3 rounded-2xl border border-[rgba(249,115,22,0.35)] bg-[var(--bg-surface)] p-4 shadow-[0_18px_44px_-10px_rgba(0,0,0,0.5)]">
            ...
            <div className="min-w-0 flex-1">
              ...
              <a
                href="/auth/signin"
                className="mt-2 inline-flex items-center gap-1 font-['Outfit',sans-serif] text-[14px] font-bold text-[var(--accent-orange)] hover:underline"
              >
                Prisijungti →
              </a>
            </div>
                ...
                return (
                  <div className={visibleAlbums.length > 0 ? 'mt-6' : ''}>
                    {visibleAlbums.length > 0 && (
                      <div className="mb-2.5 font-['Outfit',sans-serif] text-[16px] font-extrabold uppercase tracking-[0.15em] text-[var(--text-muted)]">
                        Kitos dainos
                      </div>
                    )}
                    <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2 lg:grid-cols-4">
                      ...
                      {hasOverflow && (
                        <button
                          ...
                          className="flex items-center justify-center rounded-xl border border-[rgba(249,115,22,0.35)] bg-[rgba(249,115,22,0.12)] p-2 font-['Outfit',sans-serif] text-[16px] font-extrabold tracking-tight text-[var(--accent-orange)] transition-colors hover:border-[var(--accent-orange)] hover:bg-[rgba(249,115,22,0.22)]"
            ...
            <section>
              ...
              {previewThreads.length > 0 && (
                <>
                  ...
                  <div className="mb-3 mt-2 font-['Outfit',sans-serif] text-[16px] font-extrabold uppercase tracking-[0.15em] text-[var(--text-muted)]">
                    Kitos temos
                  </div>
