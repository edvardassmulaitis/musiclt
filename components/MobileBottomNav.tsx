  ...
  return (
    <>
      ...
      <nav className="mbn" aria-label="Apatinė navigacija">
        ...
        {/* Topai — taurė (I.trophy iš top header, kad ikonų serija sutaptų) */}
        <Link href="/topai" className={`mbn-item${isTopai ? ' active' : ''}`} aria-label="Topai">
          <span className="mbn-ico">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 21h8M12 17v4M7 4h10v5a5 5 0 0 1-10 0V4Z"/><path d="M17 4h3v3a3 3 0 0 1-3 3M7 4H4v3a3 3 0 0 0 3 3"/></svg>
          </span>
        </Link>
