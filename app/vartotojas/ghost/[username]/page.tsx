      ...
      >
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px', display: 'flex', gap: 20, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 14, color: 'var(--text-muted)', display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              {activity.user_rank && (
                <span>
          ...
          >
            {activity.artists.map((a) => (
              ...
              >
                ...
                <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-primary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', width: '100%' }}>
                  {a.name}
                </div>
              </Link>
            ))}
