...
// Senieji žemėlapio komponentai (TerritoryMap — packed circles, MapWorld —
// žanrų burbulai) pašalinti: jie buvo projektuoti 116 teritorijų ir skaitiniams
// ID. v3 duoda 526 teritorijas su tekstiniais ID — žemėlapį dabar piešia
// components/gilyn/GilynMap.tsx (režimai Žemėlapis / Laikas).
