        ...
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#111822] via-[#0a1018] to-[#080c12] border border-white/[.06]">
          ...
          <div className="relative p-6 sm:p-10 lg:p-14">
            ...
            <div className="flex items-center justify-between mb-6 sm:mb-10">
              ...
              <div className="text-[10px] sm:text-[11px] text-[#5e7290] font-bold uppercase tracking-wider" style={{ fontFamily: "'Outfit', sans-serif" }}>
                ...
                <div className="flex justify-between gap-1.5 sm:gap-3 mt-3">
                  {sortedMeter.map((s) => (
                    <div key={s.legacy_id} className="flex-1 min-w-0 text-center">
                      <div className="text-[10px] sm:text-xs font-extrabold text-[#dde8f8] truncate" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        {s.name}
                      </div>
                      <div className="text-[10px] sm:text-[11px] text-[#5e7290] font-mono mt-0.5">{(s.percent || 0).toFixed(0)}%</div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {favoriteStyles && favoriteStyles.length > 0 && (
              <div>
                <div className="text-[10px] font-extrabold uppercase tracking-wider text-[#5e7290] mb-3" style={{ fontFamily: "'Outfit', sans-serif" }}>
