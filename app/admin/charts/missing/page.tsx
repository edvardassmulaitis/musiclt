  ...
  return (
    <div className="border-b border-gray-100 px-3 py-2.5 last:border-b-0">
      <div className="flex items-center gap-3">
        <span className="shrink-0 rounded bg-amber-100 px-2 py-0.5 text-[11px] font-bold tabular-nums text-amber-700" title="Keliuose topuose">{m.chartCount}×</span>
        ...
        {msg && <span className="shrink-0 text-[11px] font-medium text-gray-500">{msg}</span>}
