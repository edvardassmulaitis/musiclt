...
import { openNotifications } from '@/components/NotificationsBell'
  ...
  return (
    <>
      ...
      <nav className="mbn" aria-label="Apatinė navigacija">
        ...
        {/* Pranešimai → atidaro NotificationsBell dropdown */}
        <button type="button" className="mbn-item" aria-label="Pranešimai" onClick={() => openNotifications()}>
          <span className="mbn-ico">
