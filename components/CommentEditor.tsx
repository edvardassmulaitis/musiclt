    ...
    >
      ...
      >
        <div className="border-b border-[var(--border-subtle)] px-4 py-3">
          ...
          {hint && (
            <div className="mt-0.5 text-[14px] text-[var(--text-muted)]">
              {hint}
            </div>
          )}
        </div>
        ...
        >
          <input
            ...
            className="w-full rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-surface)] px-3 py-2 text-[14px] text-[var(--text-primary)] outline-none transition-colors placeholder:text-[var(--text-faint)] focus:border-[var(--accent-orange)]"
          />
          <div className="mt-3 flex items-center justify-end gap-2">
            <button
              type="button"
              onClick={onCancel}
              className="rounded-full border border-[var(--border-subtle)] bg-transparent px-3.5 py-1.5 text-[14px] font-bold text-[var(--text-muted)] transition-colors hover:border-[var(--border-strong)] hover:text-[var(--text-primary)]"
            >
              Atšaukti
            </button>
            <button
...
const CommentEditor = forwardRef<CommentEditorHandle, Props>(function CommentEditor({
  ...
  return (
    <div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-elevated)] focus-within:border-[var(--accent-orange)]">
      ...
      <div className="px-3 py-2 text-[14px] leading-snug text-[var(--text-primary)]">
