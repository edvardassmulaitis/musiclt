...
2) Kiekvienam laikotarpiui pateik:
   - title: TRUMPAS lietuviškas pavadinimas (1–3 žodžiai), pvz. „Pradžia", „Klasika", „Stadium pop", „Eksperimentai", „Solo karjera", „Comeback". NE direct'inis vertimas, o žmogiškas, įsimenamas.
   - subtitle: NULL (nereikia, ant mobile per ilga)
   - year_start: pradžios metai (skaičius)
   - year_end: pabaigos metai (skaičius), arba null jei laikotarpis tęsiasi iki šių dienų
   - description: 1–2 sakiniai lietuvių kalba apie tai, kas svarbu šitam laikotarpiui. Įvardyk pagrindinius albumus pavadinimais kabutėse („Album Title") ir užminei reikšmę. NE direct'inis vertimas.
3) Sortuok JSON masyvą NUO NAUJAUSIO LAIKOTARPIO Į SENIAUSIĄ (newest first).
4) Pirmas elementas (naujausias) turi sort_order=0, antras=1 ir t.t.
5) NESUTAPYK metų intervalų — kiekvienas albumas turi tilpti į vieną erą.
6) Jei wiki neturi aiškios laikotarpių struktūros — sukurk pagrįstas pagal albumų išleidimo metus (dekados ar pora dekadų), bet vis tiek duok prasmingus title.

ATSAKYMAS — TIK JSON masyvas be jokio papildomo teksto, be markdown'o code fence, be paaiškinimo. Pavyzdys formato:
...
[
  ...
  {"sort_order": 1, "title": "Stadium pop", "subtitle": null, "year_start": 2008, "year_end": 2018, "description": "Coldplay tampa vieni didžiausių pasaulio stadium grupių. „Viva la Vida", „Mylo Xyloto" ir „A Head Full of Dreams" — masinė publika."}
]`
