              ...
              <div className="flex items-center gap-2.5 self-start">
                ...
                {isOwner && (
                  <button type="button" onClick={() => setEditOpen(true)}
                          className="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[14px] font-bold transition hover:opacity-90"
      ...
      <div className="relative">
        ...
        <header className="px-4 pt-3 pb-3">
          ...
          <div className="mt-2.5 flex items-start gap-3">
            {bioSnippet ? (
              <p className="flex-1 min-w-0 text-[14px] leading-[1.45] line-clamp-3 pf-hero-bio"
                 style={{ fontFamily: "'Outfit', sans-serif" }}>
                {bioSnippet}
              </p>
        ...
        {tags.map((tg) => {
          ...
          return (
            <button key={tg.key ?? 'all'} type="button" onClick={() => setFilter(tg.key)}
                    className="flex-shrink-0 inline-flex items-center gap-1 rounded-full px-3 py-1 text-[14px] font-bold transition"
                    style={{
  ...
  return (
    <li>
      <Link href={url} className="group flex gap-3 p-2.5 rounded-xl transition hover:-translate-y-0.5"
        ...
        <div className="min-w-0 flex-1">
          <div className="text-[12px] font-extrabold uppercase tracking-wider mb-0.5"
          ...
          {isTranslation ? (
            post.summary && <p className="mt-0.5 text-[14px] truncate" style={{ color: 'var(--text-muted)' }}>{post.summary}</p>
          ) : (
  ...
  return (
    <Link href={href} className="group block rounded-lg overflow-hidden transition hover:-translate-y-0.5"
      ...
      <div className="relative aspect-square w-full overflow-hidden"
        ...
        <div className="absolute top-1 left-1 px-1.5 py-0.5 rounded-md text-[12px] font-extrabold uppercase tracking-wide backdrop-blur-sm"
      ...
      <div className="p-1.5">
        ...
        {artist && (
          <div className="text-[12px] truncate mt-0.5" style={{ color: 'var(--text-muted)', fontFamily: "'Outfit', sans-serif" }}>
            {artist.name}
          </div>
        )}
      </div>
      ...
      <Link href={item.url || '#'}
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-1.5 mb-0.5">
            ...
            <span className="text-[12px] uppercase tracking-wider font-bold flex-shrink-0"
          ...
          {item.subtitle && (
            <p className="mt-0.5 text-[14px] line-clamp-1"
  ...
  return (
    ...
    >
      ...
      <div className="px-1.5 py-1 flex flex-col gap-0">
        <span className="text-[12px] font-bold uppercase tracking-wide" style={{ color: 'rgba(249,115,22,0.9)', fontFamily: "'Outfit', sans-serif" }}>
          Nuotaikos daina
        </span>
        <span className="text-[12px] font-bold leading-tight line-clamp-1" style={{ color: 'rgba(255,255,255,0.9)', fontFamily: "'Outfit', sans-serif" }}>
          {track.title}
        </span>
        {artist && (
          <span className="text-[12px] leading-tight truncate" style={{ color: 'rgba(255,255,255,0.55)', fontFamily: "'Outfit', sans-serif" }}>
            {artist.name}
          </span>
        )}
      </div>
    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-1">
          {count > 1 && (
            <span className="text-[12px] font-extrabold px-1.5 py-0.5 rounded-full" style={{ background: 'rgba(249,115,22,0.14)', color: 'var(--accent-orange)', fontFamily: "'Outfit', sans-serif" }}>{count}</span>
          )}
          <button
            type="button"
      ...
      <div className="flex-1 flex items-center gap-3.5 pt-0.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          {artist && (
            <div className="mt-1 font-semibold text-[14px] sm:text-[14px] leading-snug line-clamp-2"
...
function MoodSongPlaceholder() {
  return (
    ...
    >
      ...
      <span className="mt-1 text-[14px] leading-snug"
            style={{ color: 'var(--text-muted)', fontFamily: "'Outfit', sans-serif" }}>
        ...
        {items.map((it) => {
          ...
          return (
            <button
              ...
              className="inline-flex items-center rounded-full px-3 py-1 text-[14px] font-semibold transition hover:opacity-90"
              style={{
                fontFamily: "'Outfit', sans-serif",
  ...
  return (
    <div className="mb-4 flex items-end justify-between gap-3 flex-wrap">
      <div>
        ...
        {meta && (
          <p className="text-[14px] sm:text-xs mt-1" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-muted)' }}>
            {meta}
          </p>
        )}
      </div>
        ...
        {shown.map((al: any) => {
          ...
          return (
            <Link key={al.id} href={href}
              ...
              <div className="p-2.5">
                <div className="text-[12px] uppercase tracking-wider truncate"
...
function MoreTile({ remaining, onOpenMore }: { remaining: number; onOpenMore: () => void }) {
  return (
    ...
    >
      ...
      <span className="mt-1.5 text-[12px] font-extrabold uppercase tracking-wider" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-muted)' }}>
        Visi →
      </span>
    </button>
  )
      ...
      <div className="flex gap-2.5 sm:gap-3 min-w-max items-stretch">
        ...
        {moreHref && remaining > 0 && (
          ...
          >
            ...
            <span className="mt-1 text-[12px] font-bold uppercase tracking-wider text-center" style={{ fontFamily: "'Outfit', sans-serif" }}>
              Visa istorija
            </span>
          </Link>
        )}
...
function PostMetaRow({
  ...
  return (
    <div className="mt-2 flex items-center gap-3 text-[12px] uppercase tracking-wider font-bold"
  ...
  return (
    <Link href={url} className="group flex flex-col no-underline h-full">
      <div className="relative aspect-video w-full overflow-hidden rounded-xl border border-[var(--border-default)] bg-[var(--cover-placeholder)] shadow-[0_4px_12px_rgba(0,0,0,0.25)] transition-all duration-300 group-hover:-translate-y-0.5 group-hover:border-[rgba(249,115,22,0.5)] group-hover:shadow-[0_14px_32px_rgba(249,115,22,0.18)]">
        ...
        <div className="absolute top-1.5 left-1.5 px-1.5 py-0.5 rounded-md backdrop-blur-sm text-[12px] font-extrabold uppercase tracking-wider text-white truncate max-w-[88%]"
             style={{ background: 'rgba(0,0,0,0.55)' }}>
          {kicker}
        </div>
      </div>
      <div className="mt-1.5 px-0.5">
        ...
        {isTranslation ? (
          post.summary && (
            <p className="m-0 mt-1 truncate text-[14px] text-[var(--text-muted)]">{post.summary}</p>
          )
        ) : (
          <PostMetaRow date={post.published_at} likes={post.like_count || 0} comments={post.comment_count || 0} tone="muted" />
        )}
  ...
  return (
    <Link href={url}
      ...
      <div className="relative aspect-[16/9] overflow-hidden"
        ...
        {typeLabel && (
          <div className="absolute top-3 left-3 px-2 py-1 rounded-full backdrop-blur-md text-[12px] font-extrabold uppercase tracking-wider"
...
function SidePostCard({ post, blogSlug }: { post: any; blogSlug: string }) {
  ...
  return (
    <Link href={url}
      ...
      <div className="min-w-0 flex-1">
        <div className="text-[12px] font-extrabold uppercase tracking-wider mb-1"
        ...
        {post.summary && (
          <p className="text-[14px] mt-1 line-clamp-1"
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-baseline gap-1.5 flex-wrap mb-0.5">
                  ...
                  <span aria-hidden style={{ color: 'var(--text-faint)' }}>·</span>
                  <span className="text-[12px] uppercase tracking-wider font-bold" style={{ color: 'var(--text-faint)', fontFamily: "'Outfit', sans-serif" }}>
                    {date}
                  </span>
                  {c.like_count > 0 && (
                    <>
                      <span aria-hidden style={{ color: 'var(--text-faint)' }}>·</span>
                      <span className="text-[12px] font-bold" style={{ color: 'var(--text-muted)' }}>♥ {c.like_count}</span>
                    </>
                  )}
                </div>
                {title && (
                ...
                {snippet && (
                  <p className="mt-1 text-[14px] line-clamp-2"
                     style={{ color: 'var(--text-secondary)', fontFamily: "'Outfit', sans-serif" }}>
                    „{snippet}"
                  </p>
                )}
      ...
      <Link href={url}
        ...
        <div className="flex min-w-0 flex-1 flex-col px-5 py-4">
          <div className="flex flex-wrap items-center gap-2.5">
            <span className="px-2 py-0.5 rounded-md text-[12px] font-extrabold uppercase tracking-wider text-white"
                  style={{ background: typeColor, fontFamily: "'Outfit', sans-serif" }}>
              Topas{listCount ? ` · ${listCount}` : ''}
            </span>
            <h3 className="text-[16px] sm:text-[16px] font-extrabold leading-snug group-hover:text-[var(--accent-orange)] transition line-clamp-2"
                style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>
              {post.title}
            </h3>
          </div>
          <div className="mt-3 grid gap-3" style={{ gridTemplateColumns: `repeat(${entries.length + (listCount > entries.length ? 1 : 0)}, minmax(0, 1fr))` }}>
            {entries.map((it, i) => (
              <div key={i} className="flex min-w-0 flex-col gap-1.5">
                <div className="relative aspect-square w-full overflow-hidden rounded-lg" style={{ background: 'var(--cover-placeholder)' }}>
                  ...
                  <span className="absolute left-1.5 top-1.5 flex h-[20px] min-w-[20px] items-center justify-center rounded-md px-1 text-[14px] font-black text-white"
                        style={{ background: i === 0 ? typeColor : 'rgba(0,0,0,0.65)', fontFamily: "'Outfit', sans-serif" }}>{i + 1}</span>
                </div>
                <div className="min-w-0">
                  <p className="m-0 truncate text-[14px] font-bold leading-tight" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>{it.title || '—'}</p>
                  {it.artist && <p className="m-0 truncate text-[12px]" style={{ color: 'var(--text-muted)' }}>{it.artist}</p>}
                </div>
              </div>
            ))}
            {listCount > entries.length && (
              <div className="flex min-w-0 flex-col gap-1.5">
                ...
                <p className="m-0 truncate text-[14px] font-bold" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--accent-orange)' }}>Daugiau →</p>
              </div>
            )}
          </div>
          <div className="mt-3">
  ...
  if (isTranslation) {
    return (
      <Link href={url} className="group block rounded-2xl p-4 transition hover:-translate-y-0.5 border border-[var(--border-default)] bg-[var(--bg-surface)] hover:border-[var(--border-strong)]">
        <span className="inline-block px-2 py-0.5 rounded-md text-[12px] font-extrabold uppercase tracking-wider text-white mb-2"
              style={{ background: typeColor, fontFamily: "'Outfit', sans-serif" }}>Vertimas</span>
        <h3 className="text-[16px] font-extrabold leading-tight group-hover:text-[var(--accent-orange)] transition"
            style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>
          {post.title}
        </h3>
        {post.summary && <p className="mt-1 text-[14px] truncate" style={{ color: 'var(--text-muted)' }}>{post.summary}</p>}
        <PostMetaRow date={post.published_at} likes={post.like_count || 0} comments={post.comment_count || 0} tone="muted" />
      </Link>
    )
  }
    ...
    return (
      <Link href={url}
        ...
        <div className="flex min-w-0 flex-1 flex-col px-4 py-4 sm:px-5">
          {typeLabel && (
            <span className="self-start px-2 py-0.5 rounded-md text-[12px] font-extrabold uppercase tracking-wider text-white"
                  style={{ background: typeColor, fontFamily: "'Outfit', sans-serif" }}>
              {typeLabel}
            </span>
          )}
          <h3 className="mt-2 text-[16px] sm:text-[16px] font-extrabold leading-snug group-hover:text-[var(--accent-orange)] transition line-clamp-2"
              style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>
            {post.title}
          </h3>
          {post.summary && (
  ...
  if (isCreation) {
    return (
      <Link href={url} className="group block rounded-2xl p-5 transition hover:-translate-y-0.5"
        ...
        <span className="inline-block px-2 py-0.5 rounded-md text-[12px] font-extrabold uppercase tracking-wider text-white mb-2.5"
              style={{ background: typeColor, fontFamily: "'Outfit', sans-serif" }}>
          {post.creation_subtype ? `Kūryba · ${post.creation_subtype}` : 'Kūryba'}
        </span>
        <h3 className="text-[20px] font-bold leading-snug group-hover:text-[var(--accent-orange)] transition"
  ...
  return (
    <Link href={url} className="group block rounded-2xl overflow-hidden transition hover:-translate-y-0.5"
      ...
      <div className="relative px-6 pt-9 pb-5"
        ...
        {typeLabel && (
          <span className="relative inline-block px-2 py-0.5 rounded-md text-[12px] font-extrabold uppercase tracking-wider mb-2.5 text-white"
                style={{ background: 'rgba(0,0,0,0.25)', fontFamily: "'Outfit', sans-serif" }}>
            {typeLabel}
          </span>
        )}
        <p className="relative text-[16px] leading-relaxed text-white line-clamp-3 italic"
           style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
          {post.summary || post.title}
        </p>
      </div>
      <div className="px-5 pt-3 pb-3.5">
        <h3 className="text-[16px] font-extrabold leading-snug group-hover:text-[var(--accent-orange)] transition line-clamp-2"
            style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>
          {post.title}
        </h3>
        <PostMetaRow date={post.published_at} likes={post.like_count || 0} comments={post.comment_count || 0} tone="muted" />
  ...
  return (
    <div className="flex items-start gap-3 rounded-xl px-2.5 py-2.5" style={{ background: win ? 'rgba(249,115,22,0.10)' : undefined }}>
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="truncate text-[14px] mt-0.5" style={{ color: win ? 'rgba(249,115,22,0.85)' : 'var(--text-muted)' }}>
          {artist ? `${artist.name} · ${dateShort}` : dateShort}
        </div>
        {p.comment && <div className="mt-1 text-[14px] leading-snug" style={{ color: 'var(--text-secondary)' }}>{p.comment}</div>}
      </div>
      {(p.like_count || 0) > 0 && <span className="text-[14px] font-bold flex-shrink-0 mt-1" style={{ color: win ? 'var(--accent-orange)' : 'var(--text-faint)' }}>♥ {p.like_count}</span>}
    </div>
  )
}
    ...
    <Link href={href} className="group flex w-[150px] flex-shrink-0 flex-col gap-1.5 transition hover:-translate-y-0.5">
      <div className="relative w-full overflow-hidden rounded-lg" style={{ aspectRatio: '16 / 9', background: 'rgba(249,115,22,0.10)' }}>
        ...
        {((p.like_count || 0) > 0 || p.is_winner) && (
          <span className="absolute right-1 top-1 px-1.5 py-0.5 rounded-full text-[12px] font-extrabold backdrop-blur-md"
      ...
      <div className="min-w-0">
        <div className="line-clamp-2 text-[14px] font-bold leading-tight group-hover:text-[var(--accent-orange)] transition" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>{track?.title || 'Daina'}</div>
        {artist && <div className="truncate text-[12px] mt-0.5" style={{ color: 'var(--text-muted)' }}>{artist.name}</div>}
      </div>
    </Link>
  )
}
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: 'var(--card-bg)', border: '1px solid var(--border-subtle)' }}>
      ...
      <button type="button" onClick={() => setAllOpen(true)} className="group flex w-full items-center gap-2.5 px-5 pt-4 pb-2 flex-wrap text-left">
        ...
        <h3 className="text-[16px] font-extrabold group-hover:text-[var(--accent-orange)] transition" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>
          {label}
        </h3>
        <span className="ml-auto text-[14px] font-bold" style={{ color: 'var(--text-faint)' }}>{picks.length} →</span>
      </button>
      ...
      <div className="flex gap-2.5 px-5 pb-4 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        {remaining > 0 && (
          <button type="button" onClick={() => setAllOpen(true)} className="group flex w-[150px] flex-shrink-0 flex-col gap-1.5 text-left">
            ...
            <div className="truncate text-[14px] font-bold" style={{ color: 'var(--accent-orange)', fontFamily: "'Outfit', sans-serif" }}>Daugiau →</div>
          </button>
        )}
      </div>
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: 'var(--card-bg)', border: '1px solid var(--border-subtle)' }}>
      <div className="flex items-center gap-2.5 px-5 pt-4 pb-2 flex-wrap">
        ...
        <h3 className="text-[16px] font-extrabold" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>{label}</h3>
      </div>
          ...
          return (
            <Link key={`${it._kind}-${it.id}`} href={href} className="group block rounded-lg overflow-hidden transition hover:-translate-y-0.5"
              ...
              <div className="relative aspect-square w-full overflow-hidden">
                ...
                <span className="absolute top-1 left-1 px-1.5 py-0.5 rounded text-[12px] font-extrabold uppercase tracking-wide text-white"
                      style={{ background: 'rgba(0,0,0,0.55)' }}>
                  {KIND_LABEL[it._kind]}
                </span>
              </div>
              <div className="p-1.5">
                <div className="text-[14px] font-bold leading-tight line-clamp-1" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>
      ...
      <button type="button" onClick={() => onOpenMore('track')}
              className="block w-[calc(100%-40px)] mx-5 mb-3.5 text-center text-[14px] font-bold rounded-lg py-2 transition hover:opacity-85"
          ...
          {items.map((it) => {
            ...
            return (
              <Link key={`${it._kind}-${it.id}`} href={href} className="group flex w-[88px] flex-shrink-0 flex-col gap-1.5 transition hover:-translate-y-0.5">
                ...
                <div className="truncate text-[14px] font-bold leading-tight group-hover:text-[var(--accent-orange)] transition" style={{ fontFamily: "'Outfit', sans-serif", color: 'var(--text-primary)' }}>{isArtist ? it.name : it.title}</div>
              </Link>
            )
          })}
  ...
  return (
    <div className="rounded-2xl p-4" style={{ background: 'var(--card-bg)', border: '1px solid var(--border-subtle)' }}>
      ...
      {items.length > 0 ? (
            ...
            return (
              <Link key={`${it._kind}-${it.id}`} href={href}
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {subtitle && (
                    <div className="text-[14px] truncate mt-0.5" style={{ color: 'var(--text-muted)' }}>
                      {subtitle}
                    </div>
                  )}
                </div>
        ...
        <p className="text-[14px] py-2 px-1" style={{ color: 'var(--text-muted)' }}>Pamėgtos muzikos dar nėra</p>
      )}
    </div>
  )
}
...
function FollowCtaCard({ profile }: { profile: any }) {
  return (
    <div className="rounded-2xl text-center px-5 py-6"
      ...
      <div className="text-[16px] font-extrabold text-white mb-1" style={{ fontFamily: "'Outfit', sans-serif" }}>
        Patinka, ką rašo @{profile.username}?
      </div>
      <div className="text-[14px] mb-3.5" style={{ color: 'rgba(255,255,255,0.6)', fontFamily: "'Outfit', sans-serif" }}>
