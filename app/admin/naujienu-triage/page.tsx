            ...
            <div key={it.discussion_id}
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  <span className={`shrink-0 px-1.5 py-0.5 rounded text-[12px] font-bold ${STATUS_COLOR[it.status]}`}>{STATUS_LABEL[it.status]}</span>
                  {!it.has_text && <span className="shrink-0 px-1.5 py-0.5 rounded text-[12px] bg-gray-100 text-gray-500">tik antraštė</span>}
