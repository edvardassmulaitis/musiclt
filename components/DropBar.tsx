      ...
      {segments.map((s, i) => {
        ...
        return (
          ...
          >
            ...
            <span
              className={[
                "font-['Outfit',sans-serif] text-[13px] font-extrabold tabular-nums tracking-tight",
            ...
            {pulsing && (
              <span
                aria-hidden
                className="pointer-events-none absolute left-1/2 top-0 -translate-x-1/2 -translate-y-3 text-[12px] font-extrabold text-[var(--accent-orange)]"
