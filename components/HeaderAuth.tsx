...
```
  ...
  <div className="relative bg-gray-900 border border-white/10 rounded-2xl p-8 w-full max-w-sm shadow-2xl">
    ...
    <div className="text-center mb-8">
      ...
      <p className="text-gray-400 text-sm mt-1">Prisijunkite prie bendruomenės</p>
    </div>
      ...
      <div className="py-1">
        ...
        {isAdmin && (
          <Link
            ...
            onClick={() => setOpen(false)}
            className="flex items-center gap-3 px-4 py-2.5 text-sm text-music-orange hover:bg-white/5 transition-colors font-medium"
          >
            <span>⚙️</span> Admin panelė
          </Link>
        )}
...
<button
onClick={() => setShowModal(true)}
className=“px-4 py-1.5 text-[13px] bg-music-orange hover:bg-orange-500 text-white rounded-full font-bold transition-colors”
>
Registruotis
</button>
