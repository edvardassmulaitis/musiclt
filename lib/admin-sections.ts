...
export const ADMIN_SECTIONS: AdminSection[] = [
  ...
  { key: 'yt-siuksles', group: 'content', minRole: 'editor', href: '/admin/yt-siuksles', icon: '🧽', label: 'YouTube šiukšlės', hint: 'Dainos su YT peržiūromis bet be embed — nunulinti šiukšlines peržiūras' },
