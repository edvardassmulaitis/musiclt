...
//   - app/diskusijos/[slug]/page.tsx (h1 + breadcrumb + metadata)
 ...
 *  (su trailing legacy ID, ar pure lower-case ASCII/LT diakritikai be
 *  jokio didžiosios raidės/skyrybos), reikia perleisti per
