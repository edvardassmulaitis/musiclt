...
export const ADMIN_SECTIONS: AdminSection[] = [
  ...
  { key: 'matyti-gyvai',   group: 'review', minRole: 'editor', href: '/admin/matyti-gyvai',   icon: '🎤', label: 'Matyti gyvai',            hint: 'Narių „mačiau gyvai" pasiūlymai — nauji atlikėjai / renginiai', badgeKey: 'seen_live_pending' },
  ...
  { key: 'naujienu-triage',group: 'review', minRole: 'editor', href: '/admin/naujienu-triage',icon: '🎙️', label: 'Recenzijų triage',        hint: 'Legacy RECENZIJA įrašai → autorius (byline) → narys → narių įrašas', badgeKey: 'reviews_pending' },
  ...
  { key: 'teritorijos',    group: 'review', minRole: 'editor', href: '/admin/teritorijos',    icon: '🗺️', label: 'Muzikos žemėlapis',       hint: 'Pasauliai → teritorijos → atlikėjai. Tuščios teritorijos = spragos bazėje', badgeKey: 'terr_empty' },
  ...
  { key: 'duplikatai', group: 'content', minRole: 'editor', href: '/admin/duplikatai', icon: '🧹', label: 'Dainų tvarkymas', hint: 'Dublikatai · YT be embed · populiarūs be YT — sujungti / valyti / enrichinti' },
  { key: 'duplikatai-atlikejai', group: 'content', minRole: 'admin', href: '/admin/duplikatai-atlikejai', icon: '🧑‍🎤', label: 'Atlikėjų dublikatai', hint: 'Tas pats slug ≥2 atlikėjams → pasirinkti keeper’į + sujungti' },
  ...
  { key: 'feed',     group: 'content', minRole: 'editor', href: '/admin/feed', icon: '📲', label: 'Pagrindinis feed\'as', hint: 'Homepage „istorijų" srautas — kandidatai / prisegti / slėpti / pertvarkyti', badgeKey: 'feed_pending' },
...
const ADMIN_ONLY_PREFIXES = [
  ...
  '/admin/yt-backfill',
  '/admin/search',
  '/admin/duplikatai-atlikejai',
  '/api/admin/duplikatai-atlikejai',
  '/api/admin/users',
  '/api/admin/import',
