  ...
  return (
    <div style={{ maxWidth: 820, margin: '0 auto', padding: '28px 20px 80px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20, gap: 12, flexWrap: 'wrap' }}>
        ...
        <Link href="/skelbimai/naujas" style={{ padding: '9px 16px', fontSize: 14, fontWeight: 700, borderRadius: 9, background: 'var(--accent-blue)', color: '#fff', textDecoration: 'none' }}>+ Įdėti skelbimą</Link>
      </div>
