          ...
          >
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <label className="sm:col-span-2">
                <span className="block text-[12px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Pavadinimas *</span>
                <input
                  type="text"
                  autoFocus
              ...
              <label>
                <span className="block text-[12px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Metai nuo *</span>
                <input
                  type="number"
              ...
              <label>
                <span className="block text-[12px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Metai iki (tuščia = „dabar")</span>
                <input
                  type="number"
              ...
              <label className="sm:col-span-2">
                <span className="block text-[12px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Aprašymas</span>
                <textarea
        ...
        >
          ...
          >
            ...
            <label className="block">
              <span className="block text-[12px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Atlikėjo vardas</span>
              <input
                type="text"
                value={aiWikiUrl}
          ...
          {eras.map((e, i) => (
            ...
            >
              <div className="mb-2 flex items-center gap-2">
                ...
                <div className="ml-auto flex gap-1">
                  <button
                    onClick={() => move(i, -1)}
                    disabled={i === 0}
                    className="rounded px-2 py-1 text-[14px] text-[var(--text-muted)] hover:bg-[var(--bg-hover)] disabled:opacity-30"
                    aria-label="Į viršų"
                  >↑</button>
                  <button
                    onClick={() => move(i, 1)}
                  ...
                  <button
                    onClick={() => removeEra(i)}
                    className="rounded px-2 py-1 text-[14px] text-red-500 hover:bg-red-50"
                    aria-label="Trinti"
                  >✕</button>
                </div>
              </div>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-12">
                ...
                <label className="sm:col-span-6">
                  <span className="block text-[12px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Paantraštė (opt)</span>
                  <input
                    type="text"
                    value={e.subtitle || ''}
                ...
                <label className="sm:col-span-6">
                  <span className="block text-[12px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Šaltinis</span>
                  <input
                    type="text"
                ...
                <label className="sm:col-span-12">
                  <span className="block text-[12px] font-bold uppercase tracking-wider text-[var(--text-muted)]">Aprašymas (1-2 sakiniai)</span>
                  <textarea
                    value={e.description || ''}
