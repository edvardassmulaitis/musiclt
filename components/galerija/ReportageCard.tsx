  ...
  return (
    ...
    >
      <div className="relative aspect-[3/2] overflow-hidden bg-[var(--bg-elevated)]">
        ...
        {r.photoCount > 0 && (
          <span className="absolute right-2.5 top-2.5 inline-flex items-center gap-1 rounded-full bg-black/65 px-2 py-[3px] text-[14px] font-bold text-white backdrop-blur">
            {CAMERA}
            {r.photoCount}
          </span>
        )}
      ...
      <div className="p-3.5">
        ...
        <h3 className="line-clamp-2 font-['Outfit',sans-serif] text-[16px] font-bold leading-snug text-[var(--text-primary)]">
