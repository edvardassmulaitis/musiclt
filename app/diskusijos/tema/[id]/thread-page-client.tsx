    ...
    <div style={{ background: 'var(--bg-body)', color: 'var(--text-primary)', minHeight: '100vh', fontFamily: "'DM Sans',system-ui,sans-serif" }}>
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '32px 24px 80px' }}>
        ...
        <div style={{
          ...
          fontSize: 14, color: 'var(--text-muted)', fontFamily: 'Outfit,sans-serif', fontWeight: 600,
        ...
        {thread.source_url && (
          <div style={{ marginTop: 14 }}>
            <a href={thread.source_url} target="_blank" rel="noopener noreferrer"
               style={{ color: 'var(--accent-orange)', fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>
    ...
    <div style={{
      ...
      {!compact && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 2, padding: '6px 8px', borderBottom: '1px solid var(--border-subtle)' }}>
          ...
          <div style={{ flex: 1 }} />
          <span style={{ fontSize: 12, color: 'var(--text-faint)', padding: '0 6px' }}>
            ...
            <div style={{ marginTop: 8, display: 'flex', alignItems: 'center', gap: 8, position: 'relative' }}>
                    ...
                    {hits.map((h) => (
                      ...
                      >
                        ...
                        <div style={{ minWidth: 0, flex: 1 }}>
                          ...
                          {h.artist && <div style={{ fontSize: 12, color: 'var(--text-muted)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{h.artist}</div>}
                        </div>
                      </button>
                    ))}
                  </div>
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 14, fontWeight: 800, cursor: sending ? 'default' : 'pointer',
                  fontFamily: 'Outfit,sans-serif',
                }}
              >
