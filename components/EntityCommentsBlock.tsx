    ...
    <div className="mt-1 space-y-1">
      ...
      {olderCount > 0 && (
        <button
          ...
          className="ml-1 inline-flex items-center gap-1 text-[13px] font-bold text-[var(--text-faint)] transition-colors hover:text-[var(--accent-orange)]"
        >
      ...
      {showCount && (
        onOpenModal ? (
          <button
            ...
            className={[
              "flex items-center border-l px-2 py-1 font-['Outfit',sans-serif] text-[12.5px] font-extrabold tabular-nums tracking-wide transition-colors",
          ...
          <span
            className={[
              "flex items-center border-l px-2 py-1 font-['Outfit',sans-serif] text-[12.5px] font-extrabold tabular-nums tracking-wide",
...
export default function EntityCommentsBlock({
  ...
  const SortChip = ({ k, label }: { k: 'newest' | 'oldest' | 'popular'; label: string }) => (
    <button
      ...
      onClick={() => setSort(k)}
      className={[
        "rounded-full px-2.5 py-1 font-['Outfit',sans-serif] text-[12.5px] font-extrabold transition-colors",
        sort === k
    ...
    <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-3">
        ...
        <div className="mb-2 flex flex-wrap gap-1.5">
          {attached.map((hit, i) => (
            ...
            >
              ...
              <span className="font-['Outfit',sans-serif] text-[13.5px] font-bold">{hit.title}</span>
              <button
                type="button"
      ...
      <div className="mt-2 flex items-center justify-between gap-2">
        <button
          ...
          className={[
            "inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 font-['Outfit',sans-serif] text-[13px] font-extrabold transition-colors",
            attached.length > 0
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full bg-[var(--accent-orange)] px-4 py-1.5 font-['Outfit',sans-serif] text-[13.5px] font-extrabold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
        >
          {posting ? 'Siunčiama…' : (
            <>
      ...
      {error && (
        <div className="mt-2 text-[13px] font-bold text-[#ef4444]">{error}</div>
      )}
      {!session?.user?.id && (
  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      {toast && (
        ...
        >
          <div
            className="flex items-center gap-2 rounded-full px-4 py-2 text-[14.5px] font-bold shadow-2xl"
            style={{
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h3
          className={compact
            ? "font-['Outfit',sans-serif] text-[13px] font-extrabold uppercase tracking-[0.18em] text-[var(--text-muted)]"
      ...
      {modern === null || legacy === null ? (
        ...
        <div className="rounded-xl border border-dashed border-[var(--border-default)] px-4 py-6 text-center">
          <div className="text-[14.5px] font-bold text-[var(--text-muted)]">Komentarų dar nėra</div>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {quoteAuthor && quoteText && (
                      <div className="mt-1.5 rounded border-l-[3px] border-[var(--accent-orange)] bg-[var(--bg-elevated)] px-2.5 py-1.5">
                        <div className="font-['Outfit',sans-serif] text-[12.5px] font-extrabold text-[var(--text-secondary)]">
                          {quoteAuthor} rašė:
                        </div>
                        <div className="mt-0.5 line-clamp-3 text-[13.5px] italic text-[var(--text-muted)]">
                          {quoteText}
                        </div>
                      </div>
                    )}
                        ...
                        {c.music_attachments.slice(0, 8).map((a: any, i: number) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className="font-['Outfit',sans-serif] text-[13.5px] font-bold text-[var(--text-primary)]">
                                {a.title}
                              </span>
                              {a.artist && a.type !== 'grupe' && (
                                <span className="text-[12px] text-[var(--text-muted)]">· {a.artist}</span>
                              )}
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      {!isDeleted && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 font-['Outfit',sans-serif] text-[13px] font-extrabold text-[var(--text-muted)] transition-colors hover:text-[var(--accent-orange)]"
                        >
                      ...
                      {isDeleted && (
                        <span className="inline-flex items-center gap-1 rounded-full border border-[var(--border-subtle)] bg-[var(--bg-elevated)] px-2 py-0.5 font-['Outfit',sans-serif] text-[12px] font-extrabold uppercase tracking-wider text-[var(--text-muted)]">
                          Paslėpta
                        </span>
                      )}
                      ...
                      {isDeleted && isModern && (() => {
                        ...
                        return (
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-full border border-[var(--accent-orange)]/40 bg-[var(--accent-orange)]/10 px-2 py-0.5 font-['Outfit',sans-serif] text-[12.5px] font-extrabold text-[var(--accent-orange)] transition-colors hover:bg-[var(--accent-orange)]/20"
                          >
                      ...
                      {(() => {
                        ...
                        return (
                          <button
                            ...
                            className="ml-auto inline-flex items-center gap-1 rounded-full border border-[rgba(239,68,68,0.3)] bg-[rgba(239,68,68,0.08)] px-2 py-0.5 font-['Outfit',sans-serif] text-[12.5px] font-extrabold text-[#ef4444] transition-colors hover:border-[#ef4444] hover:bg-[rgba(239,68,68,0.16)]"
                          >
          ...
          >
            ...
            <div className="px-4 pt-3">
              <div className="rounded-lg border-l-[3px] border-[var(--accent-orange)] bg-[var(--bg-elevated)] px-3 py-2">
                <div className="font-['Outfit',sans-serif] text-[12px] font-extrabold uppercase tracking-wider text-[var(--text-secondary)]">
                  {modalReplyTo.name} rašė:
                </div>
                <div className="mt-1 line-clamp-4 text-[14px] italic text-[var(--text-muted)]">
                  {modalReplyTo.text}
                </div>
              </div>
            </div>
            ...
            <div className="px-4 py-3">
              ...
              {replyAttached.length > 0 && (
                <div className="mt-2 flex flex-wrap gap-1.5">
                  {replyAttached.map((a, i) => (
                    <div
                      key={`${a.type}-${a.id}-${i}`}
                      className="inline-flex items-center gap-1 rounded-full border border-[var(--border-subtle)] bg-[var(--bg-elevated)] px-2 py-1 text-[13px]"
                    >
              ...
              {replyError && (
                <div className="mt-2 rounded-md border border-red-500/30 bg-red-500/10 px-2 py-1 text-[13px] text-red-400">
                  {replyError}
                </div>
              )}
              ...
              <div className="mt-3 flex items-center justify-between gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-full border border-[var(--border-default)] bg-[var(--bg-elevated)] px-3 py-1.5 text-[13px] font-bold text-[var(--text-secondary)] hover:bg-[var(--bg-hover)]"
                >
                  ♪ Pridėti dainos
                </button>
                <div className="flex items-center gap-2">
                  <span className="text-[12px] text-[var(--text-faint)]">⌘+Enter siųsti</span>
                  <button
                    type="button"
                    onClick={submitReply}
                    disabled={replyPosting || (!replyDraft.trim() && replyAttached.length === 0)}
                    className="rounded-full bg-[var(--accent-orange)] px-4 py-1.5 text-[14px] font-bold text-white shadow-md transition-opacity hover:opacity-90 disabled:opacity-40"
                  >
